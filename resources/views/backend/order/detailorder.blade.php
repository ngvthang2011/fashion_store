                    ...
                    <div class="bootstrap-table">
                        <div class="table-responsive">
                                        ...
                                        <div class="panel panel-blue">
                                            ...
                                            <div class="panel-body">
                                                <strong><span class="glyphicon glyphicon-user"
                                                        aria-hidden="true"></span> : {{ $customer->full_name }}</strong> <br>
                                                <strong><span class="glyphicon glyphicon-phone"
                                                        aria-hidden="true"></span> : Số điện thoại: {{ $customer->phone }}</strong>
                                                <br>
                            ...
                            <div class="alert alert-primary" role="alert" align='right'>
                                <a class="btn btn-success" href="admin/order/active-order/{{ $customer->id }}" role="button">Đã xử lý</a>
                            </div>
                        </div>
                    </div>
